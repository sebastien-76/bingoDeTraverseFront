            ...
            {showModal && (
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <Bouton style={{ height: "2.5rem", width: "70px", backgroundColor: "var(--purple-pastel)", border: "1px solid var(--purple-pastel)" }} text="oui" onClick={() => confirmDeletePhrase(selectedPhrase.id)} />
